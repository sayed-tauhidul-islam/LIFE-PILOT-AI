...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'ড্যাশবোর্ড'); ?> — LP_AI</title>
...
<body class="theme-<?php echo e(auth()->user()->theme_preference ?? 'black-red'); ?>">

    <!-- SIDEBAR -->
    <nav class="sidebar" id="sidebar">
        <a href="<?php echo e(url()->current()); ?>" class="sidebar-logo" onclick="window.location.reload(); return false;" title="রিফ্রেশ করুন">
        ...
        <div class="sidebar-nav">
            ...
            <a href="<?php echo e(route('transactions.index')); ?>"
                class="nav-item <?php echo e(request()->routeIs('transactions.*') ? 'active' : ''); ?>">
                <i class="fas fa-exchange-alt"></i> লেনদেন
            </a>
            <a href="<?php echo e(route('budget.index')); ?>"
                class="nav-item <?php echo e(request()->routeIs('budget.*') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('health.index')); ?>"
                class="nav-item <?php echo e(request()->routeIs('health.*') ? 'active' : ''); ?>">
                <i class="fas fa-heartbeat"></i> স্বাস্থ্য প্রোফাইল
            </a>

            <div class="nav-section-title">সেটিংস</div>
            <div class="nav-group <?php echo e(request()->routeIs('settings.*') ? 'open' : ''); ?>" id="settings-group">
                <button type="button" class="nav-item nav-item-toggle <?php echo e(request()->routeIs('settings.*') ? 'active' : ''); ?>" id="settings-toggle">
                    <i class="fas fa-sliders-h"></i> সেটিংস
                    <i class="fas fa-chevron-right chevron"></i>
                </button>
                <div class="nav-sub">
                    <a href="<?php echo e(route('settings.index')); ?>" class="nav-sub-item <?php echo e(request()->routeIs('settings.index') ? 'active' : ''); ?>">
                        <i class="fas fa-house"></i> Home
                    </a>
                    <a href="<?php echo e(route('settings.theme')); ?>" class="nav-sub-item <?php echo e(request()->routeIs('settings.theme*') ? 'active' : ''); ?>">
                        <i class="fas fa-palette"></i> Theme
                    </a>
                    <a href="<?php echo e(route('settings.ai')); ?>" class="nav-sub-item <?php echo e(request()->routeIs('settings.ai*') ? 'active' : ''); ?>">
    ...
    <div class="main-content">
        ...
        <div class="topbar">
            <div class="topbar-left">
                ...
                <div>
                    <div class="topbar-title"><?php echo $__env->yieldContent('page-title', 'ড্যাশবোর্ড'); ?></div>
                    <div class="topbar-subtitle"><?php echo e(now()->translatedFormat('l, F j Y')); ?></div>
                </div>
            </div>
        ...
        <div class="page-content">
            ...
            <?php endif; ?>
            <?php if(session('info')): ?>
                <div class="alert alert-info"><i class="fas fa-info-circle"></i> <?php echo e(session('info')); ?>
    ...
    `;
        ...
        try {
            const pusherKey = '<?php echo e(env("PUSHER_APP_KEY")); ?>';
...
<?php /**PATH F:\My projects\Life-Pilot-AI\LP_AI\LP_AI\resources\views/layouts/app.blade.php ENDPATH**/ ?>