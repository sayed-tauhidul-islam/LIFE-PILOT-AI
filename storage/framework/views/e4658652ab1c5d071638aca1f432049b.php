...
<div class="layout">
  ...
  <aside class="sidebar">
    ...
    <a href="#" class="nav-item">
      ...
      <div class="avatar"><?php echo e($user->avatar ?? \Illuminate\Support\Str::substr($user->name ?? '', 0, 1)); ?></div>
      <div>
        <div class="user-name"><?php echo e($user->name ?? 'ব্যবহারকারী'); ?></div>
        <div class="user-role"><?php echo e($user->profile_complete ? 'প্রিমিয়াম সদস্য' : 'সাধারণ সদস্য'); ?></div>
      </div>
        ...
        <div class="hero-inner">
          <div>
            <div class="hero-greeting">
              সুপ্রভাত, <span style="background:linear-gradient(135deg,#e9d5ff,#a5f3fc);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;"><?php echo e($user->name ?? 'ব্যবহারকারী'); ?></span> <span class="wave">👋</span>
            </div>
          ...
          <div class="hero-kpi">
              ...
              <div class="hero-kpi-value">৳<?php echo e(number_format($monthStats->balance ?? 0, 0)); ?></div>
              <div class="hero-kpi-change"><i class="fas fa-arrow-up" style="font-size:10px;"></i> FinScore: <?php echo e($finScore ?? 0); ?></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="stats-grid fade-up delay-1">
        <div class="stat-card purple">
          ...
          <div class="stat-header">
            ...
            <div class="stat-trend trend-up"><i class="fas fa-arrow-up" style="font-size:10px;"></i> <?php echo e(round(($monthStats->income ?? 0) / ($monthStats->expense ?? 1) * 100)); ?>%</div>
          </div>
          <div class="stat-label">মোট ব্যালেন্স</div>
          <div class="stat-value">৳<?php echo e(number_format($monthStats->balance ?? 0, 0)); ?></div>
          <div class="stat-sub">মাসিক: <?php echo e($user->monthly_income ? number_format($user->monthly_income, 0) : 'N/A'); ?></div>
        </div>
...
</html><?php /**PATH F:\My projects\Life-Pilot-AI\LP_AI\LP_AI\resources\views/dashboard/index.blade.php ENDPATH**/ ?>